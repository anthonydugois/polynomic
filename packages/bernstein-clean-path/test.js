...
} from "bernstein-clean-path"

describe("clean-path", function () {
  it("should simplify the closures of the path", function () {
    const path = parsePathstring("M0 0L100 0L100 100l-100 -100 M50 50h50v50l-50-50")
  ...
  it("should make the path start with a M point", function () {
    const path = parsePathstring("L0 0zL0 0")
  ...
  it("should delete the two consecutive same points", function () {
    const path = parsePathstring("M0 0L50 50L50 50L50 50")
  ...
  it("should clean the invalid path", function () {
    const path = parsePathstring("L0 0l50 50l0 0h50v50 L0 0")
